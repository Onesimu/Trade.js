...
<style lang="less">
   #order .weui_cells{margin-top: 10px;}
   #order .order_bottom{margin-top: 10px; padding: 10px;}
</style>
<script>
    ...
    export default{
        data(){
            return{
                ...
                isClick : false,
                selectOptions : [
                    {key:'template',value:"模板止损"},
                    {key:'point',value:"点位止损"}
                ],
                curSelect :  "",
//                radioData:[
...
//                }
                ...
                d =    curData.holdCash;
                 let       curs = {CNY:'人民币',USD:'美元',EUR:'欧元',HKD:'港币'};
                 let cur = curs[curData.cur];
              return [
                    {key:"0.5",
                        value : "止损"+ d*0.5 + cur +",止盈"+ d*0.5*2+ cur},
                    {key:"1",value : "止损"+d*1 + cur+ ",止盈"+ d*1*2 + cur},
                    {key:"2",value : "止损"+d*2 + cur+ ",止盈"+ d*2*2 + cur }
                ];
            }
        },
        route:{
