...
<style lang="less">
    ...
    .holdContent ul{width: 100%; height: 40px; display: block;}
    .holdContent li{float: left; width: 100px; line-height: 40px; text-align: center;height: 40px; text-align: center;}
    ul.holdHd{background: #f8f8f8;}
    .holdContent li.big{width:150px;}
    .acc_left{float: left;line-height: 40px;}
    .acc_left span.name{width:190px; float: left; padding-left:10px;}
    .acc_left span.winLoss{float: left;}
    .acc_body .oper{width:100%; float: left; text-align:center; margin-top:10px;line-height: 26px; }
    .acc_body .operBtn{width:80px; height: 26px; border-radius: 7px; display: inline-block; margin:0 7px; color:#fff; padding: 0;}
    .firstRow{width: 100%;height: 20px;}
    .firstRow span{display: inline-block;float: left;width:20%; height: 20px; text-align: center; font-size: 12px;line-height:20px; color: #565656; padding: 0;}
    .secondRow span{display: inline-block;float: left;width:45%; height: 20px;font-size: 12px;line-height:20px; color: #565656;padding: 0;}
</style>
<script>
