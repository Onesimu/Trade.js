<template>
    <div id="User">
        ...
        <group>
            ...
            <cell title="&nbsp;&nbsp;&nbsp;入金记录" is-link v-link="{path:'/moneyInHis'}">
                <span class="icon jyjl" slot="icon"></span>
            </cell>
        </group>
    </div>
...
<style lang="less">
    .userInfo {
        width:100%;
        height: 110px;
        background: url("../../img/bg_blue.png") no-repeat center 0;
    ...
    .zjmx{background: url("../../img/cou_01.png") no-repeat 0 0;}
    .jyjl{background: url("../../img/cou_02.png") no-repeat 0 0;}
    .kyzj{background: url("../../img/cou_10.png") no-repeat 0 0;}
    .zjhz{background: url("../../img/cou_13.png") no-repeat 0 0;}
</style>
<script>
    import {setRate} from "vuex/actions"
