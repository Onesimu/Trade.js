...
<style lang="less">
    ...
    .moneyInHisContent ul{width: 100%; height: 40px; display: block;}
    .moneyInHisContent li{float: left; width: 100px; line-height: 40px; text-align: center;height: 40px; text-align: center;}
    ul.moneyInHisHd{background: #f8f8f8;}
    .moneyInHisContent li.big{width:150px;}
    .firstAcc .acc_head{border-top:1px solid #d8d8d8;}
    .acc_body .name {
        float: left;
        width: 30%;
        padding-right: 10px;
