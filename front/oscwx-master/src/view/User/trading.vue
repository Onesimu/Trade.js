...
<style lang="less">
    ...
    .tradingContent ul{width: 100%; height: 40px; display: block;}
    .tradingContent li{float: left; width: 100px; line-height: 40px; text-align: center;height: 40px; text-align: center;}
    ul.tradingHd{background: #f8f8f8;}
    .tradingContent li.big{width:150px;}
